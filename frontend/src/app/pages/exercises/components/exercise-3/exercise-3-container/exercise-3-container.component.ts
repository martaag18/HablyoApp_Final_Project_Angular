...
import { Exercise3PresentationComponent } from '../exercise-3-presentation/exercise-3-presentation.component';
// Mocks
import { EXERCISES_3 } from '../data/mocks/exercise-3-examples.mock';
...
import { Exercise3IntroductionComponent } from './exercise-3-introduction/exercise-3-introduction.component';
...
export class Exercise3ContainerComponent {
  ...
  allExercises = signal<ExerciseData[]>(EXERCISES_3);
  ...
  onCircleDropped(payload: { letterIndex: number; mark: 'circle' }): void {
    this.dragDropService.dropCircle(payload.letterIndex, payload.mark);
  }
}
